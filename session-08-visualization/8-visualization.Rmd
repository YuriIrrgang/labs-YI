...
```{r}
penguins_histogram <- ggplot(penguins, aes(x = body_mass_g)) +
  geom_histogram(bins = 20, fill = "red")
penguins_histogram

penguins_density <- ggplot(penguins, aes(x = body_mass_g)) +
  geom_density(fill = "red")
penguins_density

penguins_bar <- ggplot(penguins, aes(x = body_mass_g)) +
  geom_bar(fill = "red")
penguins_bar
...
```{r}
penguins_box <- ggplot(penguins %>% na.omit(), aes(x = sex, y = body_mass_g)) +
